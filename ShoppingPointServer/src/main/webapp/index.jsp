...
<html>
	...
	<body>
		...
		<form id="loginForm" name="loginForm" action="/ShoppingPointServer/webapi/login" method="POST">
				<table border="0">
					<tr>
						<td><p id="loginUsernameText">Username</p></td>
						<td><input type="text" name="username" placeholder="Enter username" id="username" size="50" /></td>
					</tr>
					<tr>
						<td><p id="loginPasswordText">Password</td>
						<td><input type="password" name="password" placeholder="Enter password"  id="password" size="50"  /></td>
					</tr>
				</table>
